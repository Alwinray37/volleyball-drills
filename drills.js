// array containing objects of warm up drills
export const warmUpDrills = [
    ...
    },
    {
        ...
        description: "Two groups of players in one line facing each other from sideline to sideline. Players pass/set the ball to the other side and moving to the other line as well.",
        image: "https://thrivevolleyball.com/wp-content/uploads/2019/05/shuttle-passing-cover.jpg"
    },
    {
        name: "Team Pepper",
    ...
    {
        name: "Dot Drill",
        description: "PLayers start in center of the court. Coach tosses ball over the net; short, sideline, and deep. Player works to pass each and go back to the center after each pass.",
        image: "https://thrivevolleyball.com/wp-content/uploads/2018/04/dot-drill-1-400x250.jpg"
    },
    {
        name: "Volleyball Tennis",
        description: "Just like shuttle passing but over the net. Players go on the court one by one receiving the ball and sending it over in one touch.",
        image: "https://thrivevolleyball.com/wp-content/uploads/2018/04/1v1-tennis-400x250.jpg"
    },
    {
        name: "Serve Relay",
        description: "Players split into to groups, they go against each other in a realy race. If the serve goes over the net and in, the player only runs half court and back. If the player misses the serve, they have to run the whole court. Add zones for intermediate or higher players.",
        image: "https://thrivevolleyball.com/wp-content/uploads/2019/05/serve-relay-1-400x250.jpg"
    },
    {
        name: "Pepper",
...
export const skillDrills = [
    ...
    },
    {
        ...
        description: "Serve/Receive drill, start by splitting the court in half endline-to-endline. Servers will be at the right side of the endline serving straight, while two receivers work on passing on the same line. Switch sides after a few minutes.",
        image:"https://thrivevolleyball.com/wp-content/uploads/2022/02/split-court-sr-400x250.jpg"
    },
    {
